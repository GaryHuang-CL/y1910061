<?php
	...
	$plan = array(
			array(5855,  37152,   9479,   208 ,  50,   1 , 99, 99),
			array('',    '',      '',      '' ,  50,   '' ,99, 99),
			array('',    '',      '',      '' ,  50,   '' ,99, 99),
			array('',    '',      '',      '' ,  50,   '' ,99, 99),
			array('',    '',      '',      '' ,  50,   '' ,99, 99),
	...
	foreach ($posts as $i => $postfields) {
		if($i == 0){
			$content = $content . 'php catapult-child.php "' . $postfields. '" ' . (1000000 * 0.8) . " &\n";
		}else{
			$content = $content . 'php catapult-child.php "' . $postfields. '" ' . (1000000 * 1) . " &\n";
		}
	}
