<?php
	...
	{
		// <p class="b f16"><a href="karte.php?d=384819&c=b4"><span class="c0">占拠中オアシス (-62|-80)</span></a></p>
		...
		foreach($matches as $match){
			...
			for($i = 0; $i < 30; $i++){
				...
				// TIME REMAIN
				// <td width="50%">&nbsp; 場所： <span id=timer14>0:16:40</span> 後</td>
				...
				// ARRIVE TIME
				// <td width="50%">時間： 15:44:45</span><span> 時</td></tr></table></td></table></p>
